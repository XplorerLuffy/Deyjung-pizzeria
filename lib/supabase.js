...
// Lazily create the client so module import never throws at build time
// (createClient is only called the first time a property is accessed,
//  which happens in the browser inside useEffect — never during SSR/prerender)
let _client = null;
